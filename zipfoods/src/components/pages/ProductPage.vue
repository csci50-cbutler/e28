<template>
  <div id="product-page" v-if="product">
    ...
    <button @click="addToCart(slug)" data-test="add-to-cart-button">
      Add to cart
    </button>

    <transition name="fade">
      <div data-test="add-to-cart-confirmation" class="alert" v-if="addAlert">
        Your cart has been updated!
      </div>
    </transition>

    <router-link :to="{ name: 'products' }"
      >&larr; Return to all products</router-link
    >
  </div>
</template>
