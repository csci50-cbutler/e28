    ...
    <div>
        ...
        <div id='inputs'>
            ...
            <div v-if='$v.product.name.$error'>
                <div class='form-feedback-error' v-if='!$v.product.name.required'>Name is required.</div>
            </div>
            ...
            <input data-test='product-price-input' type='text' v-model='product.price' id='price' />
        ...
        <button @click='addProduct' data-test='add-product-button'>Add Product</button>
